...
import blossom.project.towelove.common.utils.JwtUtils;
...
import blossom.project.towelove.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthGlobalFilter implements GlobalFilter, Ordered {
    ...
    private Mono<Void> unauthorizedResponse(ServerWebExchange exchange, String msg) {
        ...
        return ServletUtils.webFluxResponseWriter(exchange.getResponse(), msg, com.towelove.common.core.constant.HttpStatus.UNAUTHORIZED);
    }
