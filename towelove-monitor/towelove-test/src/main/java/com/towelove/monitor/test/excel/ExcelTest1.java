...
public class ExcelTest1 {
    public static void main(String[] args) {
        ...
        classSchedule.setClassName(split[0]);
        classSchedule.setTeacher(split[1]);
        classSchedule.setStartWeek(split[2]);
        classSchedule.setClassroom(split[3]);
        classSchedule.setDay(3);
        classSchedule.setStart(9);
        classSchedule.setEnd(11);
